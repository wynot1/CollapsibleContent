 ...
 * Description.
 *
 * @package WynotWebdev\Module\FAQ\Custom
 * @since   1.0.0
 * @author  wynot
...
namespace WynotWebdev\Module\FAQ\Custom;
...
function register_faq_custom_post_type() {
	...
	$args = array(
		...
		'labe'          => __( 'FAQs', FAQ_MODULE_TEXT_DOMAIN ),
...
function get_post_type_labels_config( $post_type, $singular_label, $plural_label ) {
	return array(
		...
		'all_items'          => __( 'All ' . $plural_labelQs, FAQ_MODULE_TEXT_DOMAIN ),
